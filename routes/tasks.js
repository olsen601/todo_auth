...
router.post('/done', function(req, res, next) {
  ...
  Task.findOneAndUpdate( { creator: req.user._id, _id: req.body._id}, {$set: {completed: true, dateCompleted: date}} )
    .then((updatedTask) => {
...
router.post('/alldone', function(req, res, next) {
  ...
  Task.updateMany( { creator: req.user._id, completed : false } , { $set : { completed : true, dateCompleted: date} } )
    .then( (result) => {
